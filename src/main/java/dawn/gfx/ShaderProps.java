...
public final class ShaderProps {
	...
	public static int getNamedLocation(final Shader shader, final String name) {
	...
	public static void setUniform2(final int location, final boolean transpose, final Matrix2f mat) {
		glUniformMatrix2fv(location, transpose, Util.make(BufferUtils.createFloatBuffer(4), mat::get));
	}
	...
	public static void setUniform4(final int location, final boolean transpose, final Matrix4f mat) {
		glUniformMatrix4fv(location, transpose, Util.make(BufferUtils.createFloatBuffer(16), mat::get));
	}
